...
class Asset:
    def __init__(
        self, symbol: str = "", alpaca_model_asset: trading.models.Asset = None
    ) -> None:
        self.alpaca_model_asset = alpaca_model_asset
        assert (
            symbol != "" or type(alpaca_model_asset) == trading.models.Asset
        ), "An asset needs a symbol or a alpaca "
    ...
    def submit(self, order):
        market_order = self.trading_client.submit_order(order_data=order)
        return market_order
